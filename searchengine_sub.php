...
if(isset($_POST['submit']))
{
	...
	$query = "SELECT R.fname,R.lname,R.M_id,R.city,F.fees_per_hr,R.Qualification as Qualification,X.Rating ,R.Resume_Link FROM mentor_reg R , fees F,feedback X where R.M_id=F.M_id and F.Sub_id=(select Sub_id from subject where Sub_name='$sub_name') and X.M_id=R.M_id and X.Sub_name =(select Sub_name from subject where Sub_name='$sub_name') ";
...
echo"<tr><td>Fname</td><td>Lname</td><td>City</td><td>Fees_per_hr</td><td>Qualification</td><td>Rating</td><td>About_Mentor</td><td>Choose</td></tr>";
...
?>
  <tr>
    ...
    <td><a href="resume.php?id=<?php echo $row['Resume_Link']; ?>">Resume</a></td>
