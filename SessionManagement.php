...
{//echo $id;
    ...
    $slot = $_POST['slot'];
 $q1 = "select slot_or_date from sessionmanagement where slot_or_date = '$slot' ";
$result1 = mysqli_query($dbname,$q1);
$val=(mysqli_fetch_assoc($result1));

if($val)
{
	echo "Slot already booked.Please choose another date.";
}
else
{
...
if($result){
    echo "Your session is successfully booked";
} else{
